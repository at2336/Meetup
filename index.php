...
if(!isset($_SESSION['username']))
	header("Location: indexNotLogged.php");
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <header id="myCarousel" class="carousel slide">
        ...
        <div class="carousel-inner">
            <div class="item active">
                ...
                <div class="carousel-caption">
                    <h2>Welcome to Meetup, <?php echo $_SESSION['username']; ?>!</h2>
        ...
        <div class="well">
            <div class="row">
                <div class="col-md-4">	
					<form action = "search_events.php" method = "post" role = "form">
						<input type="text" class="form-control" placeholder="Search Events - Enter Name or ID" class="glyphicon glyphicon-star" aria-hidden="true" name = "searchEvents">
