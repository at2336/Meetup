...
<body>
    ...
    <nav class="navbar-default navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                -->
                    <li>
                        <a href="interest_group.php">Interest Group</a>
                    </li>
                    <li>
    ...
    <div class="container">
        ...
        <div class="form-group">
            <form action = "search_group_interests.php" role = "form" method = "post">
                <label for="sel1">Select Interests:</label>
                <select class="form-control" id="sel1" name = "findGroup" action = "search_group_interests.php" onchange = 'this.form.submit()'>
					...
					if($result)
					{
						...
						{
							$temp = $row['interest_name'];
							echo "<option value=\"$temp\">" . $row['interest_name'] . "</option>"; 
						}
					}
					else
						echo "<option value=\"noInterests\">" . "You have no interests, please join one first!" . "</option>";
					?>
                </select>
            </form>
        <br>
        ...
        <div class="row">
            ...
            <div class="signup-container">
                <div class="first-box">
                    <span style="color:red"><h2>Input Your Interests!</h2></span>
                </div>
				<form action = "search_group_interests.php" role = "form" method = "post">
                <div class ="search-input-box">
                    <div class="input-group">
						  <input type="text" name = "searchGroups" class="form-control" placeholder="Input Interests...">
